                                            ...
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="top-end"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('category.edit', $Categorys->id) }}"> Edit </a>
                                                    @php
                                                        $Category_Count = App\Models\Product::where('category_id', $Categorys->id)->count();
                                                    @endphp

                                                    @if ($Category_Count < 1)
                                                        <button class="dropdown-item" style="cursor: pointer;" type="button"
                                                            onclick="delete_Category({{ $Categorys->id }})">Delete
                                                        </button>

                                                        <form id="delete-Category-{{ $Categorys->id }}"
