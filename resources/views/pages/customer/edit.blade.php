...
<div class="dt-content">
    <div class="card shadow-lg rounded-0">
        <div class="card-header">
            <h3 class="m-0 d-flex justify-content-between">Customer Update
                ...
                <div class="form-row">
                    <div class="col-xl-12 col-sm-12 col-12 form-group">
                        <div class="text-center">
                            @if ($Edit->avatar)
                            <img id="oneImage" src="assets/image/customer/{{ $Edit->avatar }}" class="rounded-circle " style="width: 100px; height: 100px;" alt="">
                            @else
