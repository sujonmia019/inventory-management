            ...
            @csrf
                ...
                <div class="form-row">
                    <div class="col-xl-4 col-sm-6 col-12 form-group">
                        ...
                        <input name="product_name" type="text" value="{{ old('product_name') }}" class="form-control form-control-sm rounded-0 @error('product_name') is-invalid @enderror" placeholder="full name" autocomplete="off">
                        @error('product_name')
                ...
                <div class="form-row">
                    ...
                    <div class="col-xl-6 col-sm-6 col-12 form-group">
                        ...
                        <input type="number" name="quantity" class="form-control form-control-sm rounded-0">
                        @error('quantity')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
