                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="rounded-circle" style="width: 40px; height: 40px;"
                                                src="{{ asset('assets/image/supplier/' . $Suppliers->avatar) }}" alt="">
                                        </td>
                                            ...
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="top-end"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('supplier.show', $Suppliers->id) }}"> View </a>

                                                    <a class="dropdown-item"
                                                        href="{{ route('supplier.edit', $Suppliers->id) }}"> Edit </a>
                                                    @php
                                                        $Supplier_Count = App\Models\Product::where('supplier_id', $Suppliers->id)->count();
                                                    @endphp

                                                    @if ($Supplier_Count < 1)
                                                        <button class="dropdown-item" style="cursor: pointer;" type="button"
                                                            onclick="delete_supplier({{ $Suppliers->id }})">Delete
                                                        </button>

                                                        <form id="delete-supplier-{{ $Suppliers->id }}"
