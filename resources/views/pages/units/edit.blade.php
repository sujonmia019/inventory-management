...
<div class="dt-content">
    <div class="card shadow-lg rounded-0">
        <div class="card-header">
            <h3 class="m-0 d-flex justify-content-between">Unit Update
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input name="unit_name" type="text" value="{{ $Edit->name }}" class="form-control form-control-sm rounded-0 @error('unit_name') is-invalid @enderror">
                @error('unit_name')
